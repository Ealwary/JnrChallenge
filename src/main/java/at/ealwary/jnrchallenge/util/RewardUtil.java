...
public class RewardUtil {
    ...
    private void addRewards() {
        ...
        rewardsList.add(new ItemBuilder(Material.PUMPKIN_PIE).setDisplayName(ID.REWARD_NAME_START + Material.PUMPKIN_PIE.name()).create());
        ...
        rewardsList.add(new ItemBuilder(Material.SPECTRAL_ARROW).setDisplayName(ID.REWARD_NAME_START + Material.SPECTRAL_ARROW.name()).create());
        ...
        rewardsList.add(new ItemBuilder(Material.ENDER_EYE).setDisplayName(ID.REWARD_NAME_START + Material.ENDER_EYE.name()).create());
        ...
        rewardsList.add(new ItemBuilder(Material.FIREWORK_ROCKET).setDisplayName(ID.REWARD_NAME_START + Material.FIREWORK_ROCKET.name()).create());
        ...
        rewardsList.add(new ItemBuilder(Material.TNT).setDisplayName(ID.REWARD_NAME_START + Material.TNT.name()).create());
        ...
        rewardsList.add(new ItemBuilder(Material.ENDER_PEARL).setDisplayName(ID.REWARD_NAME_START + Material.ENDER_PEARL.name()).create());
        ...
        rewardsList.add(new ItemBuilder(Material.EXPERIENCE_BOTTLE).setDisplayName(ID.REWARD_NAME_START + Material.EXPERIENCE_BOTTLE.name()).create());
